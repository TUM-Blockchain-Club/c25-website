...
export const workshopItems = [
  ...
  // },
  {
    title: "Solana Superteam Germany Ideathon",
    url: "https://apply.tum-blockchain.com/solana-ideathon",
    description:
      "Join us for a half-day Ideathon — whether you're new to blockchain or an experienced dev, this Ideathon will be the perfect platform to explore new concepts, collaborate with like-minded individuals, and bring your ideas to life.",
    backgroundImg: "/workshops/solana-workshop.png",
    room: "Lovelace Room",
    time: "Fri · 13:30-15:45",
  },
  {
    title: "Ethereum Research Challenge",
    url: "https://apply.tum-blockchain.com/ef-research-challenge",
    description:
      "We appreciate your interest in participating in the Ethereum Foundation's Research Challenge at the TUM Blockchain Conference. In this event, you will explore active research problems in the MEV space, then work in groups (max team size is 5) to develop solutions.",
    backgroundImg: "/workshops/solana-workshop.png",
    room: "Gern",
    time: "Thu · 11:00 until Fri · 13:00",
  },
];
